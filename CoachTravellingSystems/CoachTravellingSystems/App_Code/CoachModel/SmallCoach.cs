...
/// <summary>
/// Summary description for SmallCoach
/// </summary>
public class SmallCoach : CoachInterface
{

    public SmallCoach(List<Driver> driver, Journey destination, bool service)
    {
