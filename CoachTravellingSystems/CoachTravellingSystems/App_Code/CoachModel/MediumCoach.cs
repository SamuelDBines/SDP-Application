...
/// <summary>
/// Summary description for MediumCoach
/// </summary>
public class MediumCoach : CoachInterface
{
    public MediumCoach(List<Driver> driver, Journey destination, bool service)
    {
